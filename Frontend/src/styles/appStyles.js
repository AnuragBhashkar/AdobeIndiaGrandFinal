...
export const getPdfChatStyles = (theme) => ({
    ...
    newChatButton: { width: '8vw', padding: '0.5rem', margin: '1rem 0', backgroundColor: theme.primary, color: theme.buttonText, border: 'none', borderRadius: '5px', cursor: 'pointer', fontWeight: 'bold', fontSize: '0.9rem' },
    ...
    sessionJob: { margin: 0, fontSize: '0.9rem', opacity: 0.8 , fontSize: '0.85rem' },
    ...
    button: { padding: '0.4rem 0.9rem', backgroundColor: theme.primary, color: theme.buttonText, border: 'none', borderRadius: '5px', cursor: 'pointer', fontWeight: 'bold', width: '12vw' },
    ...
    snippetFooter: { textAlign: 'right', fontSize: '0.8rem', opacity: 0.7, marginTop: '8px' , fontSize: '0.9rem' },
